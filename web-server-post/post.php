...
<head>
  <meta charset="UTF-8">
  <link rel="stylesheet" href="./staticc/css/post.css">
...
<body>
  <div class="top">
    <img class="logo" src="./staticc/images/logo-post.svg"  alt="Logo">
    <nav class="header">
  ...
  <img class="image" src="./staticc/images/the_road_ahead.jpeg" alt="The Road Ahead">
  ...
  <div class="footer">
    <img class="foot_logo" src="./staticc/images/foot_logo.svg"  alt="Logo">
    <nav class="footnav">
